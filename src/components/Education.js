    ...
    <div className='my-64'>
      ...
      <div ref={ref} className='w-[75%] mx-auto relative lg:w-[90%] md:w-full'>
        ...
        <ul className="w-full flex flex-col items-start justify-between ml-4 xs:ml-2">
            <Details
            type="Bachelors of Technology in Coumputer Science Engineering" time="2021-2025" place="Jaypee Institute of Information Technology(J.I.I.T)" 
            info="Relevant courses included such as Data Structures and Algorithms, Operating System, Computer Networks and Internet Of Things, DBMS, Artificial 
Intelligence. "
